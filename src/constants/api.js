...
export const API_LABEL_LIST = `${prefix}/label`;
export const API_LABEL_DEL = `${prefix}/label/del`;
export const API_LABEL_ADD = `${prefix}/label/add`;
export const API_LABEL_EDIT = `${prefix}/label/edit`;
export const API_LABEL_UPDATE = `${prefix}/label/update`;
